<%@ Page Title="" Language="C#" MasterPageFile="~/Site_Administrator/Administrator.Master" AutoEventWireup="true" CodeBehind="IngresoProducto.aspx.cs" Inherits="Magasys_2016.Site_Administrator.IngresoProducto" %>
        ...
        <div class="panel-body pan">
            <form class="form-horizontal" runat="server">
                <div class="form-body pal">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="inputNumIngreso" class="col-md-3 control-label">Número de Ingreso  <span class="require"></span></label>

                                <div class="col-md-9">
                                    <input id="inputNumIngreso" type="text" placeholder="" disabled="disabled" class="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="inputFechaIngreso" class="col-md-3 control-label">Fecha Ingreso  <span class="require"></span></label>

                                <div class="col-md-9">
                                    <input id="inputFechaIngreso" type="text" placeholder="" disabled="disabled" class="form-control" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 class="box-heading">Seleccionar Productos y Agregar Cantidad</h4>
