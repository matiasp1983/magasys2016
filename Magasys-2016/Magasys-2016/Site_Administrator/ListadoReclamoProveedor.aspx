<%@ Page Title="" Language="C#" MasterPageFile="~/Site_Administrator/Administrator.Master" AutoEventWireup="true" CodeBehind="ListadoReclamoProveedor.aspx.cs" Inherits="Magasys_2016.Site_Administrator.ListadoReclamoProveedor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-pink">
        <div class="panel-heading">Listado de Reclamos</div>
            ...
            <form class="form-horizontal" runat="server">
                <div class="form-body pal">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="inputNumeroReclamo" class="col-md-3 control-label">Numero de Reclamo<span class="require">*</span></label>

                                <div class="col-md-9">
                                    <input id="inputNumeroReclamo" type="text" placeholder=" " class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 class="box-heading">Listado de Reclamos</h4>
