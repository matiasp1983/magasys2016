<%@ Page Title="" Language="C#" MasterPageFile="~/Site_Administrator/Administrator.Master" AutoEventWireup="true" CodeBehind="InformePorcentual.aspx.cs" Inherits="Magasys_2016.Site_Administrator.InformePorcentual" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="panel panel-pink">
        <div class="panel-heading">Informe de comparacion de los ingresos de productos y la devolución </div>
