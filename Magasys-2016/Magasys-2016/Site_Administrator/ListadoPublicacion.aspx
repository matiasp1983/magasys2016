<%@ Page Title="" Language="C#" MasterPageFile="~/Site_Administrator/Administrator.Master" AutoEventWireup="true" CodeBehind="ListadoPublicacion.aspx.cs" Inherits="Magasys_2016.Site_Administrator.UserControls.ListadoPublicacion" %>
            ...
            <form class="form-horizontal" runat="server">
                <div class="form-body pal">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="inputNumeroPublicacion" class="col-md-3 control-label">Numero de Publicación<span class="require">*</span></label>

                                <div class="col-md-9">
                                    <input id="inputNumeroPublicacion" type="text" placeholder=" " class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 class="box-heading">Listado de Publicaciones</h4>
