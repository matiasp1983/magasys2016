<%@ Page Title="" Language="C#" MasterPageFile="~/Site_Administrator/Administrator.Master" AutoEventWireup="true" CodeBehind="ListadoEmpleado.aspx.cs" Inherits="Magasys_2016.Site_Administrator.ListadoEmpleado" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-pink">
        <div class="panel-heading">Informe de Empleados</div>
        <div class="panel-body pan">
            <form class="form-horizontal" runat="server">
                <div class="form-body pal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="inputLegajo" type="text" placeholder=" " class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 class="box-heading"> Datos de Empleados</h4>
                                ...
                                <table class="table table-hover table-striped table-bordered table-advanced tablesorter">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="7%">numero dni</th>
                                            <th width="12%">telefono</th>
                                            <th width="10%">email</th>
                                            <th width="9%">direccion</th>
                                            <th width="9%">cargo</th>
