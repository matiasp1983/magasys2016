<%@ Page Title="" Language="C#" MasterPageFile="~/Site_Administrator/Administrator.Master" AutoEventWireup="true" CodeBehind="Devoluciones.aspx.cs" Inherits="Magasys_2016.Site_Administrator.Devoluciones" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="panel panel-pink">
        <div class="panel-heading"> Ingreso de Devoluciones </div>
        <div class="panel-body pan">
            <form class="form-horizontal" runat="server">
                <div class="form-body pal">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="inputNumDevolucion" class="col-md-3 control-label">Número de Devolucion  <span class="require"></span></label>

                                <div class="col-md-9">
                                    <input id="inputNumDevolucion" type="text" placeholder="" disabled="disabled" class="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="inputFechaDevolucion" class="col-md-3 control-label">Fecha de Devolucion  <span class="require"></span></label>

                                <div class="col-md-9">
                                    <input id="inputFechaDevolucion" type="text" placeholder="" disabled="disabled" class="form-control" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 class="box-heading">Seleccionar Productos a Devolver y Agregar Cantidad</h4>
